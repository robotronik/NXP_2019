...
#define SERVO_MIN_PULSE_WIDTH_DEFAULT                                          (float)0.0013  // 0.00162 The number here should be be *pulse width* in seconds to move servo to its right limit
#define SERVO_MAX_PULSE_WIDTH_DEFAULT                                          (float)0.0017  // 0.00186 The number here should be be *pulse width* in seconds to move servo to its left limit
